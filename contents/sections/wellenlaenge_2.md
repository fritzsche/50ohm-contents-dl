...
$f[[MHz]] = \frac{300}{0,03} = \frac{300 \cdot 100}{3} = 10.000$
...
Diese Frage lässt sich wieder ganz ohne Rechnen lösen, wenn man die Frequenzzuweisungen für den Amateurfunk intus hat. Das 160-m-Band geht nämlich von $\qtyrange{1,8}{2}{\mega\hertz}$, da liegt $\qty{1,84}{\mega\hertz}$ drin - also kann die Antwort nur $\qty{163}{\meter}$ sein.
